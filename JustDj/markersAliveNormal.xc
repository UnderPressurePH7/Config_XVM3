 ...
 */
{
  ...
  "def": {
    ...
    "playerName": {
      ...
      //Nonicks "format": "<font size='{{battletype?13|{{squad?13|0}}}}'>{{name}}</font>"  // формат текста. См. описание макросов в macros.txt
        "format": "{{name}}"            //   формат текста. См. описание макросов в macros.txt
    },
    // Text field with the remaining health.
    // Текстовое поле с оставшимся здоровьем союзников.
    "tankHpAlly": {
      "name": "Tank Hp Ally",
      "enabled": true,
      "x": 0,
    ...
    // Text field with the remaining health.
    // Текстовое поле с оставшимся здоровьем врагов.
    "tankHpEnemy": {
      "name": "Tank HP Enemy",
      "enabled": true,
      "x": 0,
      ...
      "format": ${"markersShellDamage.xc":"format"}
    },
    ...
    "skill": {
      ...
      "shadow": {
       ...
       "format": "{{xvm-stat?<img src='xvm://res/icons/skill1/{{c:xr}}.png' width='60' height='2'>}}"
    }
  },
  // Settings for allies.
  ...
  "ally": {
    ...
    "vehicleDist": {
      "enabled": ${ "@settings.xc": "XVM.MarkerDistAllyN" },
      "x": -11,
      "y": -18,
      "alpha": 100,
      "align": "center",
    ...
    "textFields": [
      ${ "def.tankName" },
      ${ "def.playerName" },
      //AllyReloading ${ "@custom_texts.xc":"custom_texts.markers.Reloading" },
      //MarkersDef ${ "def.killdef" },
       ${ "def.rating" },
      //Lane ${ "def.skill" },
  ...
  "enemy": {
    ...
    "vehicleDist": {
      "enabled": ${ "@settings.xc": "XVM.MarkerDistEnemN" },
      "x": -11,
      "y": -18,
      "alpha": 100,
      "align": "center",
    ...
    "textFields": [
      ...
      ${ "def.playerName" },
      ${ "def.tankHpEnemy" },
      //EnemyReloading ${ "@custom_texts.xc":"custom_texts.markers.Reloading" },
      //MarkersDef ${ "def.killdef" },
       ${ "def.rating" },
      //Lane ${ "def.skill" },
      ${ "def.position" }
