 ...
 */
{
  ...
  "battleLoading": {
    ...
    "formatLeftNick": "{{.battleLoading.XvmUser}}{{.battleLoading.UsersCountry}}{{name%.15s~..}} <font alpha='#A0'>{{clan}}</font>",
    // Display format for the right panel (macros allowed, see macros.txt).
    // Формат отображения для правой панели (допускаются макроподстановки, см. macros.txt).
    "formatRightNick": "<font alpha='#A0'>{{clan}}</font> {{name%.15s~..}}{{.battleLoading.UsersCountry}}{{.battleLoading.XvmUser}}",
    // Display format for the left panel (macros allowed, see macros.txt).
    // Формат отображения для левой панели (допускаются макроподстановки, см. macros.txt).
    ...
    "XvmUser": "",
    "UsersCountry": "",
//XvmUserOn    "XvmUser": "<img src='xvm://res/icons/xvm/xvm-user-{{xvm-user|none}}.png'>",
//UsersCountryOn    "UsersCountry": "<img src='xvm://res/icons/flags/{{flag|default}}.png' width='16' height='12'>",
