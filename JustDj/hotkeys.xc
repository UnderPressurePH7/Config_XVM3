 ...
 */
{
  "hotkeys": {
    ...
    "damageLogAltMode":    { "enabled": true, "keyCode": 56, "onHold": true },
  	//Мое
	//Быстрый выход
	"dailyQuests" :  82,  // Num 0 - Ежедневные задачи.
	"quicklyLeave": {
		"enabled": ${ "@settings.xc": "hotkeys.quicklyLeave.quicklyLeaveEnable" },
		"keyCode": ${ "@settings.xc": "hotkeys.quicklyLeave.quicklyLeavekeyCode" },
		"modifier": "none"
	},
	//Скрыть чат
	"hideBattleChat": { 
		"enabled": ${ "@settings.xc": "hotkeys.hideBattleChat.hideBattleChatEnable" },
		"keyCode": ${ "@settings.xc": "hotkeys.hideBattleChat.hideBattleChatkeyCode" },
		"modifier": "ctrl"
	},
	//Выключить чат
	"disableBattleChat": {
		"enabled": ${ "@settings.xc": "hotkeys.disableBattleChat.disableBattleChatEnable" },
		"keyCode": ${ "@settings.xc": "hotkeys.disableBattleChat.disableBattleChatkeyCode" },
		"modifier": "ctrl"
	}
   }
 }
