 ...
 */
{
  ...
  "def": {
    ...
    "playerName": {
      ...
      "format": "{{nick}}"
	    ...
	    // Текстовое поле с числом попаданий по танку.
    "shotsMath": {
      "name": "Shots Math",           // название текстового поля, ни на что не влияет
      "enabled": true,                // false - не отображать
      "x": 0,                       // положение по оси X
      "y": "{{xvm-stat?-67|-51}}",  // положение по оси Y
      ...
      "textFormat": {
        "font": "$FieldFont",         //   название
        "size": 16,                   //   размер
        "color": "0x00ff00",          //   цвет (допускается использование динамического цвета, см. macros.txt)
      ...
      "shadow": {
        ...
        "format": "{{py:math.sum({{py:math.div({{hp>0?{{hp}}|0}},{{py:shell_damage.shell_damage}})}},0.5)%d}}"  // формат текста. См. описание макросов в macros.txt
    },
  ...
  "ally": {
    ...
    "vehicleDist": {
      "enabled": ${ "@settings.xc": "XVM.MarkerDistAllyE" },
      "x": -11,
      "y": -18,
      "alpha": 100,
      "align": "center",
  ...
  "enemy": {
    ...
    "vehicleDist": {
      "enabled": ${ "@settings.xc": "XVM.MarkerDistEnemE" },
      "x": -11,
      "y": -18,
      "alpha": 100,
      "align": "center",
