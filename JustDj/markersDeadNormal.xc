 ...
 */
{
  ...
  "def": {
    ...
    "damageText": {
      ...
      "damageMessage": "{{dmg}}",
      //Souls"damageMessage": "<img src='xvm://res/icons/spirit.png'>\n\n{{dmg}}",
      ...
      //Souls"blowupMessage": "<img src='xvm://res/icons/spirit_bk.png'>\n\n{{dmg}}"
    },
    // Floating damage values.
    // Всплывающий урон.
    "damageTextEnemy": {
      ...
      // Текст при обычном уроне (см. описание макросов в macros.txt).
      "damageMessage": "{{dmg}}",
      //Souls"damageMessage": "<img src='xvm://res/icons/spirit_enemy.png'>\n\n{{dmg}}",
      // Text for ammo rack explosion (see description of macros in the macros.txt).
      // Текст при взрыве боеукладки (см. описание макросов в macros.txt).
      "blowupMessage": "{{l10n:blownUp}}\n{{dmg}}"
      //Souls"blowupMessage": "<img src='xvm://res/icons/spirit_bk_enemy.png'>\n\n{{dmg}}"
    }
  },
  // Settings for allies.
